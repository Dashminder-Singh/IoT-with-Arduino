...
int r1=13, r2=12, r3=11, r4=10 ;                  //13,12,11,10
...
void loop() 
{
  ...
  if(digitalRead(c1)==LOW){ lcd.print("*"); pass=pass*10+8; delay(300);   }
  if(digitalRead(c2)==LOW){ lcd.print("*"); pass=pass*10+9;delay(300);   }
